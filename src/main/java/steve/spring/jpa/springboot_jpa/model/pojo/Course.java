...
public class Course {
	...
	public Course(String courseName, Integer courseCategoryId, String courseIntroduce, String courseNotice, String courseGoal, Integer userTeacherId, String coursePicture, Float coursePrice, Integer courseLevel, String coursePubDate, CourseCategory category) {
		this.courseName = courseName;
		this.courseCategoryId = courseCategoryId;
		this.courseIntroduce = courseIntroduce;
		this.courseNotice = courseNotice;
	...
	public String getCoursePubDate() {
		return coursePubDate;
	}

	public void setCoursePubDate(String coursePubDate) {
		this.coursePubDate = coursePubDate;
	}
